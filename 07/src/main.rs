...
//! modularization + some testing

use step_07::Result;
use step_07::gol::utils;
...
const TITLE: &str = "Step_07: More modularization";
...
impl Default for App {
    fn default() -> Self {
        ...
        if let Ok((cells, width, height)) = utils::read_rle(PATTERN_FILE_PATH) {
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        let window = event_loop.create_window(Window::default_attributes().with_title(TITLE)).unwrap();
